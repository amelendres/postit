...
from postit.application.get_post import GetPost
from postit.application.search_posts import SearchPosts
...
def get_post(mocker: MockFixture) -> Mock:
    return mocker.patch('postit.adapter.rest.post_blueprint.GetPost')


@pytest.fixture
def search_posts(mocker: MockFixture) -> Mock:
    return mocker.patch('postit.adapter.rest.post_blueprint.SearchPosts')
